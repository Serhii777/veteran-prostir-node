...
const sendVerificationEmail = async (useradmin) => {
  try {
    ...
    const mailOptions = {
      ...
      html: `<div><h2>Привіт друже!</h2><h3>Ласкаво просимо до адміністративної частини сайту.</h3><p>Ви можете підтвердити Вашу електронну пошту за посиланням: <a href='${process.env.SITE_DOMAIN}/auth/verify/${verificationToken}'>Натисніть тут</a> 👍 !!!</p></div>`,
    };
